    ...
    <div class="flex max-w-lg flex-col space-y-6 overflow-hidden rounded-lg p-6 shadow-md border-gray-100">
     ...
     <div class="flex flex-wrap justify-between dark:text-gray-600">
       <div class="flex space-x-2 text-sm">
         <button type="button" class="flex items-center space-x-1.5 p-1">
           <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" aria-label="Number of comments" class="h-4 w-4 fill-current dark:text-emerald-600">
         ...
         <button type="button" class="flex items-center space-x-1.5 p-1">
           <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" aria-label="Number of likes" class="h-4 w-4 fill-current dark:text-emerald-600">
