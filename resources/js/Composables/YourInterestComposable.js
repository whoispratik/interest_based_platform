...
export  function useYourInterest(props) {
   ...
   async function interestApiCall() {
    ...
    return { isEligibleForInterest, interestApiCall, interestChanged, interestChangeHandler, interestChangeControllerCall, isFetching, isFinished, interestChangeFetching };
}